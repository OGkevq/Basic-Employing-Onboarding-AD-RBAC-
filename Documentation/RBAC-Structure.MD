...
| IT | OU=IT,DC=NMG,DC=com | IT-Users | mjohnson, ppatel, tbrooks, jpaul | Domain administration, service desk systems, and core network configuration access |
| Operations | OU=Operations,DC=NMG,DC=com | Operations-Users | bfoster, dsanchez, nross | Access to facility controls, scheduling applications, and logistics shared folders |
